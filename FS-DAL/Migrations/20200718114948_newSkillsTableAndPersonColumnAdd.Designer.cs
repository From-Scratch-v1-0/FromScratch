...
namespace FS_DAL.Migrations
{
    ...
    [Migration("20200718114948_newSkillsTableAndPersonColumnAdd")]
    partial class newSkillsTableAndPersonColumnAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FS_DAL.Entities.Discussion", b =>
                {
                    b.Property<int>("DiscussionKey")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("ProjectProductKey")
                        .HasColumnType("int");

                    b.Property<string>("UserKey")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("DiscussionKey");

                    b.HasIndex("ProjectProductKey");

                    b.HasIndex("UserKey");

                    b.ToTable("Discussion","comment");
                });
            ...
            modelBuilder.Entity("FS_DAL.Entities.Skills", b =>
                {
            ...
            modelBuilder.Entity("FS_DAL.Entities.Discussion", b =>
                {
                    b.HasOne("FS_DAL.Entities.ProjectProduct", "ProjectProductKeyNavigation")
                        .WithMany("Discussions")
                        .HasForeignKey("ProjectProductKey")
